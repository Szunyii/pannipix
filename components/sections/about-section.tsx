          ...
          <div>
            ...
            >
              <h2 className="mb-3 font-sans text-3xl font-light leading-[1.1] tracking-tight text-foreground md:mb-4 md:text-6xl lg:text-7xl">
                A történedet
                <br />
                <span className="text-foreground/40">rajtad</span>
              </h2>
            </div>
            ...
            >
              <p className="max-w-md text-sm leading-relaxed text-foreground/90 md:text-lg">
                Számomra a leglényegesebb a hiteles kapcsolódás az elképzelés és
                az alkotás között — az a harmónia, ami közted és köztem születik
                meg.
              </p>
              <p className="max-w-md text-sm leading-relaxed text-foreground/90 md:text-lg">
                Hiszem, hogy egy tetoválás nem csupán látvány: érzéseket fejez
                ki, emlékeket őriz, és elgondolkodtat. Olyan jelképet alkotunk,
                amit egy életen át büszkén viselsz.
              </p>
            </div>
          </div>
            ...
            {[
              {
                value: "500+",
                label: "Tetoválás",
                sublabel: "Elkészült egyedi minta",
                direction: "right",
              },
              {
                value: "8",
                label: "Év",
                sublabel: "Tapasztalat a tűvel",
                direction: "left",
              },
              {
                value: "100%",
                label: "Egyedi",
                sublabel: "Minden dizájn kézzel rajzolt",
                direction: "right",
              },
            ].map((stat, i) => {
